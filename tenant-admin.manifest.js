    ...
    { title: "Организация", items: [
      { id: "ADM-ORG-001", mark: "ОБ", title: "Обзор", kind: "overview", scope: "Организация",
        ...
        metrics: [
          ...
          { label: "Тариф Aurora", value: "Бизнес Плюс · версия 7", meta: "Назначение активно · изменение через провайдера" },
          { label: "Основные права тарифа", value: "Календарь · файлы · мобильные приложения", meta: "До 520 пользователей · почтовый ящик до 25 ГБ" }
        ],
        attention: [
